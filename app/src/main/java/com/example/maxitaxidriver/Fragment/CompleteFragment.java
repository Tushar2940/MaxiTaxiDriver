...
import com.example.maxitaxidriver.Adapter.CompleteBookingAdapter;
...
public class CompleteFragment extends Fragment {
    ...
    CompleteBookingAdapter bookingDataAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<ResponseModel> call = apiCalling.getCompleteBookingDetail(Preferences.getInstance(context).getInt(Preferences.DRIVER_ID));
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                if (response.isSuccessful())
                {
                    ...
                    if (list.size() > 0)
                    {
                        ...
                        bookingDataAdapter = new CompleteBookingAdapter(context,list);
